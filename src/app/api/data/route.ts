...
const HeaderData: HeaderType[] = [
  {
    ...
    href: "#",
    submenu: [
      { label: "AAUCO Quantum Collective", href: "/about/quantum-collective" },
      { label: "The Collective Profile", href: "/about/collective-profile" },
      { label: "Pool of Experts", href: "/about/pool-of-experts" },
    ],
  },
  ...
  {
    label: "Global Connectivities",
    href: "#",
    submenu: [{ label: "Asean", href: "/global-connectivities/asean" }],
  },
