...
const Collective = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: "url('/images/collective/quantum.jpg')",
    ...
    >
      ...
      <div className="relative z-10">
        <div className="container max-w-6xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold mb-5 text-gray-100 text-center">
            THE AAUCo QUANTUM COLLECTIVE
          </h2>
          <div className="max-w-6xl mx-auto text-gray-200 text-base md:text-sm  mb-10">
            <p className="text-center">
              The Quantum Collective is a global circle of seven men, each
              placed with intention and purpose. As a team we are moving with
              mastery, trust, and shared conviction. From the Philippines to
              Canada, across Asia and the Pacific, Europe and the Middle East
              every member brings a distinct strength that fuels AAUCo’s mission
              forward. These are women and men who walk with me in clarity and
              courage, committed to bridging gaps, creating hope, and carrying
              the legacy of AAUCo with joy, freedom, and love for life and
              service. <br /> <br /> Six have already stepped into place, each
              one a companion in purpose. The seventh is on the way, drawn by
              something greater than invitation. Together, we are positioned to
              serve across continents, ready to build what the world needs next.
              This is the Quantum Collective, where vision breathes, and legacy
              lives.
            </p>
          </div>
